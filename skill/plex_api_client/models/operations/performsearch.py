...
class PerformSearchRequestTypedDict(TypedDict):
    query: str
    r"""The query term"""
...
class PerformSearchRequest(BaseModel):
    query: Annotated[
...
class PerformSearchResponseTypedDict(TypedDict):
    content_type: str
...
class PerformSearchResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
